...
@views function steady_diffusion_1D()
    ...
    p1 = plot(fact,conv;
                xlabel="fact",ylabel="iter/nx",title="Validation of optimal value for Reynolds number")
    plot!(fact,conv, seriestype = :scatter, color = :blue, markersize = 8)
    display(p1)
    savefig(p1,"lecture3/figs/ValRe.png")
end
