# run: mpiexec -n 4 julia --project diffusion_2D_mpi_gpu.jl
using Plots, Printf, MAT, CUDA, BenchmarkTools
import MPI
...
@views function diffusion_2D_mpi(; do_save=false,nvis=5)
    ...
    # Select device
    comm_l = MPI.Comm_split_type(comm_cart, MPI.MPI_COMM_TYPE_SHARED, me)
